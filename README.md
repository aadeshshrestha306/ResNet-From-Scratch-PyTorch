...
The 34 layer version, is trained on CIFAR-10 dataset with four learning rate values [0.1, 0.01, 0.001, 0.0001]. After 5 epochs, the loss and accuracy were as follows:
